...
class testKalmanFilter(unittest.TestCase):
    ...
    def testBackwardSmoother(self):
        ...
        self.kf1.backwardSmoother(dlm.model, np.array([[0.5]]), np.array([[0.375]]))
    ...
    def testBackwardSmootherMultiDim(self):
        ...
        self.kf11.forwardFilter(dlm.model, -1)
        self.kf11.backwardSmoother(dlm.model, rawState=state1, rawSysVar=cov1)
    ...
    def testEvolveMode(self):
        ...
        kf2 = kalmanFilter(
            discount=[0.9, 0.98], updateInnovation="component", index=dlm.componentIndex
        )
