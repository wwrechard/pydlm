...
class testDlmAccessMod(unittest.TestCase):
    ...
    def testGetMean(self):
        ...
        np.testing.assert_array_equal(
            filteredTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.filteredObs))

        # for predict filter
        predictedTrend = self.dlm5.getMean(filterType='predict')
        np.testing.assert_array_equal(
            predictedTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.predictedObs))
        ...
        np.testing.assert_array_equal(arTrend,
                                      self.dlm5._1DmatrixToArray(trueAr))
        ...
        np.testing.assert_array_equal(
            filteredTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.smoothedObs))
    ...
    def testGetVar(self):
        ...
        np.testing.assert_array_equal(
            filteredTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.filteredObsVar))

        # for predict filter
        predictedTrend = self.dlm5.getVar(filterType='predict')
        np.testing.assert_array_equal(
            predictedTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.predictedObsVar))
        ...
        np.testing.assert_array_equal(
            filteredTrend,
            self.dlm5._1DmatrixToArray(self.dlm5.result.smoothedObsVar))
